...
function GroupCard({
  ...
  return (
    <div className="group relative w-full rounded-xl border border-gray-200 bg-white text-left shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md">
      {/* ==========================================================
       * Three-dot menu
       * ========================================================== */}
      ...
      <div className="absolute right-4 top-4 z-50">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg text-gray-500 transition hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
        ...
        {menuOpen && (
          <div
            className="absolute right-0 top-11 z-[100] w-48 overflow-hidden rounded-lg border border-gray-200 bg-white py-1 shadow-xl"
            onClick={(event) =>
              event.stopPropagation()
            }
          >
