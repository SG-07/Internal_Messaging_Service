...
import { useGroupLogic } from "./GroupLogic";
      ...
      <section className="mx-auto max-w-3xl rounded-xl bg-white shadow">
        ...
        <div className="border-b px-6 py-5">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Create a new group for collaboration and communication.
          </p>
        </div>
              ...
              {createdGroup && (
                <div className="mt-3 space-y-1 text-sm text-green-700">
                  ...
                  <p>
                    ...
                    {formatStatus(createdGroup.status)}
                  </p>
                ...
                <div className="mt-3 space-y-3">
                  ...
                  <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 p-4 hover:bg-gray-50">
                    ...
                    <span>
                      ...
                      <span className="mt-1 block text-sm text-gray-500">
                        This group is created as an open group.
                      </span>
                    </span>
                  </label>
                  ...
                  <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 p-4 hover:bg-gray-50">
                    ...
                    <span>
                      ...
                      <span className="mt-1 block text-sm text-gray-500">
                        This group may require approval before it becomes
                        active.
                      </span>
                    </span>
                  </label>
              ...
              {isAdmin && (
                <div>
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    Admins can optionally assign a department. Leave this empty
                    to create a cross-department group.
                  </p>
                </div>
              )}
              ...
              {isAdmin && !isOpen && (
                <div>
                  ...
                  <p className="mt-1.5 text-xs text-gray-500">
                    Closed groups require a manager.
                  </p>
                </div>
              )}
            </div>
