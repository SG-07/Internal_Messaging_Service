...
async function callGroq(
  messages,
  { maxTokens = 500, temperature = 0.3, responseFormat = null } = {},
) {
 ...
 * the model never to treat anything inside it as a command. This is the
 * only injection defense in place right now — the Prompt Guard model
 * check was dropped since it isn't actually free on Groq; revisit later
 * if a no-cost or worthwhile-cost option turns up.
 */
